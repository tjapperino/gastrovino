...
const NAV_CARDS = [
  {
    ...
    eyebrow:     '€ 7,50 per persoon',
    title:       'Verse Borrelplanken',
    description: 'Kazen, charcuterie, vers gebrande noten en olijven — dagvers opgemaakt. Voor 2 tot 10 personen, bestellen en afhalen in de winkel.',
    cta:         'Bekijk de planken',
  },
  {
    href:        '/assortiment',
    icon:        Wine,
